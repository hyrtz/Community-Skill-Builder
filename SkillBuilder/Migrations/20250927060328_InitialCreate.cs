        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalProjectTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FinalProjectDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/assets/Avatar/Sample1.ico", "Lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet.", 36, "/assets/Community Pics/Pottery.png", 128, "Maria Santos", "Learner" },
                    { 2, "/assets/Avatar/Sample9.ico", "Lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet.", 18, "/assets/Community Pics/Weaving.png", 89, "James dela Cruz", "Artisan" },
                    { 3, "/assets/Avatar/Sample5.ico", "Lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet, consectetur on adipiscing elit, eiusmod tempor incididunt lorem ipsum dolor sit amet.", 41, "/assets/Community Pics/Woodcarving.png", 212, "Kim Navarro", "Researcher" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "/assets/Community Pics/CompletePottery.png", "/uploads/community-banner/PotteryBanner.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "user-1", "A community for learners and artisans passionate about pottery and ceramics.", false, 125, "Pottery Enthusiasts" },
                    { 2, "/assets/Community Pics/CompleteWeaving.png", "/uploads/community-banner/WeavingBanner.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "user-2", "Connecting artisans and learners who love weaving traditional and modern textiles.", false, 98, "Weaving Circle" },
                    { 3, "/assets/Community Pics/CompleteWoodcarving.png", "/uploads/community-banner/WoodCarvingBanner.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "user-3", "A space for woodcarvers to share projects, tips, and showcase craftsmanship.", false, 150, "Woodcarving Masters" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pottery", new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "A1111111", "Beginner", "15 hours", "Design, shape, and glaze a personalized vase as your final pottery project.", "Create Your Own Clay Vase", "This course provides a step-by-step guide to both traditional and modern methods of pottery...", "/assets/Courses Pics/Pottery.png", false, false, "pottery", "Pottery is the art and craft of shaping and firing clay...", "Clay, a pottery wheel or hand-building tools, access to a kiln, apron, and sponges.", "/assets/Courses Pics/Pottery.png", "Pottery", "/assets/Videos/Pottery.mp4", "You'll learn pottery basics, hand-building, wheel throwing, and glazing techniques." },
                    { 2, "Wood Carving", new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "A1111112", "Intermediate", "29 hours", "Apply your skills by carving a detailed animal figurine as your capstone project.", "Carve a Wooden Animal Figurine", "Explore the detailed world of woodcarving through this course...", "/assets/Courses Pics/Woodcarving.png", false, false, "woodcarving", "Woodcarving is the art of shaping and sculpting wood...", "Carving knives, gouges, mallet, sandpaper, safety gloves, and carving wood (basswood recommended).", "/assets/Courses Pics/Woodcarving.png", "Woodcarving", "/assets/Videos/Wood Carving.mp4", "You'll learn carving techniques like relief carving, whittling, chip carving, and finishing." },
                    { 3, "Weaving", new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "A1111113", "Professional", "18 hours", "Plan and weave a wall hanging using advanced techniques to showcase your weaving skills.", "Design a Handwoven Wall Hanging", "This advanced course in weaving introduces students to both traditional and experimental textile design...", "/assets/Courses Pics/Weaving.png", false, false, "weaving", "Weaving is the craft of interlacing threads or fibers...", "Table or floor loom, warp and weft yarns, weaving comb, shuttles, and scissors.", "/assets/Courses Pics/Weaving.png", "Weaving", "/assets/Videos/Weaving.mp4", "You’ll explore techniques in tapestry weaving, loom setup, fiber selection, and pattern creation." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A1111111", "Handcrafted pottery made using traditional Vigan techniques.", 1, "/assets/Works/JuanWorks1.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Classic Handcrafted Pottery" },
                    { 2, "A1111111", "A functional yet beautiful rustic clay pot for everyday use.", 2, "/assets/Works/JuanWorks2.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rustic Clay Pot" },
                    { 3, "A1111111", "An elegant pot showcasing intricate carvings and smooth finishing.", 3, "/assets/Works/JuanWorks3.png", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Elegant Decorative Pot" }
                });
