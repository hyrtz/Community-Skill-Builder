...
namespace SkillBuilder.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "CourseModules",
                columns: new[] { "Id", "ContentType", "CourseId", "Description", "Order", "Title", "VideoUrl" },
                values: new object[,]
                {
                    { 1, "", 1, null, 0, "Introduction", null },
                    { 2, "", 1, null, 0, "History", null },
                    { 3, "", 1, null, 0, "Session", null },
                    { 4, "", 1, null, 0, "Quiz", null },
                    { 5, "", 1, null, 0, "Final Activity", null },
                    { 6, "", 2, null, 0, "Introduction", null },
                    { 7, "", 2, null, 0, "History", null },
                    { 8, "", 2, null, 0, "Session", null },
                    { 9, "", 2, null, 0, "Quiz", null },
                    { 10, "", 2, null, 0, "Final Activity", null },
                    { 11, "", 3, null, 0, "Introduction", null },
                    { 12, "", 3, null, 0, "History", null },
                    { 13, "", 3, null, 0, "Session", null },
                    { 14, "", 3, null, 0, "Quiz", null },
                    { 15, "", 3, null, 0, "Final Activity", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ContentText", "ContentType", "CourseModuleId", "Duration", "MediaUrl", "Order", "SessionLink", "Title" },
                values: new object[,]
                {
                    { 1, "Pottery intro content something anything.", "Text", 1, null, null, 0, null, "Welcome to Pottery" },
                    { 2, "History content something anything.", "Image + Text", 2, null, "/assets/Images/pottery-history.jpg", 0, null, "History of Pottery" },
                    { 3, null, "Session", 3, null, null, 0, "https://live.pottery.com/session1", "Live Pottery Session" },
                    { 4, "Create your own pottery something anything.", "Activity", 5, null, null, 0, null, "Pottery Final Activity" },
                    { 5, "Woodcarving intro content something anything.", "Text", 6, null, null, 0, null, "Welcome to Woodcarving" },
                    { 6, "History content something anything.", "Image + Text", 7, null, "/assets/Images/woodcarving-history.jpg", 0, null, "History of Woodcarving" },
                    { 7, null, "Session", 8, null, null, 0, "https://live.woodcarving.com/session1", "Live Woodcarving Session" },
                    { 8, "Carve a wooden spoon something anything.", "Activity", 10, null, null, 0, null, "Woodcarving Final Activity" },
                    { 9, "Weaving intro content something anything.", "Text", 11, null, null, 0, null, "Welcome to Weaving" },
                    { 10, "History content something anything.", "Image + Text", 12, null, "/assets/Images/weaving-history.jpg", 0, null, "History of Weaving" },
                    { 11, null, "Session", 13, null, null, 0, "https://live.weaving.com/session1", "Live Weaving Session" },
                    { 12, "Weave a basic pattern something anything.", "Activity", 15, null, null, 0, null, "Weaving Final Activity" },
                    { 13, null, "Quiz", 4, null, null, 0, null, "Pottery Quiz" },
                    { 14, null, "Quiz", 9, null, null, 0, null, "Woodcarving Quiz" },
                    { 15, null, "Quiz", 14, null, null, 0, null, "Weaving Quiz" }
                });
